...
\newcommand{\AUTHOR}{Fugang Wang, Gregor von Laszewski, Timothy
  Whitson, Geoffrey C. Fox, Thomas R. Furlani, Robert L. DeLeon, 
  Steven M. Gallo}
...
\renewcommand{\shortauthors}{F. Wang, G. von Laszewski, et al.}
...
% To enable page numbers, uncomment this line
...
Usage based
metrics~\cite{Bollen:2007:MUM:1255175.1255273}
...
includes XSEDE publications, Microsoft Academic Graph
(MAG)~\cite{Sinha:2015:OMA:2740908.2742839}, and Web
of Science Data~\cite{www-isiwos}. For all data we used the same time period between
...
previously presented FWCI results. In Table \ref{T:field_highly_cited} we
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.75\columnwidth]{images/ptranking_histogram.pdf}
...
%\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.75\columnwidth]{images/ptranking_CDF.pdf}
...
%\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.75\columnwidth]{images/ptranking_distribution.pdf}
...
\bibliography{vonLaszewski-scimp-pearc18}
