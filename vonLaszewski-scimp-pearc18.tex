...
publications from XSEDE as well as from TeraGrid.
This data is collected from two sources. One is from the
...
all the publications published in them
to facilitate the peers comparison study. This dataset has about 2 million entries.
